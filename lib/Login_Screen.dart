...
class ShopLoginScreen extends StatefulWidget {
  ...
  @override
  State<ShopLoginScreen> createState() => _LoginScreenState();
}
  ...
  Widget build(BuildContext context) {
    ...
    return BlocProvider(
      ...
      child: BlocConsumer<ShopLoginCubit,ShopLoginStates>(
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        , ListView(
                          ...
                          children: [
                            if (state is! ShopLoginLoadingState) // Condition check
                              defaultButton(
                                function: () {
        ...
        listener: (context, state) {if (state is ShopLoginSuccessState) {
          if (state.loginmodel.status!) {
            ...
            ).then((value)  { // Mark the then block as async
